...
class CIFAR10(data.Dataset):
    ...
    def __init__(self, root, train=True,
                 ...
                 download=False,
                 noise_type=None, noise_rate=0.2, random_state=0,noise_ratio=1):
        ...
        if self.train:
            ...
            if noise_type !='clean':
                ...
                self.train_noisy_labels, self.actual_noise_rate = noisify(dataset=self.dataset, train_labels=self.train_labels, noise_type=noise_type, noise_rate=noise_rate, random_state=random_state, nb_classes=self.nb_classes, noise_ratio=noise_ratio)
